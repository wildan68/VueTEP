<template>
  <header
    class="sticky z-20 flex justify-center transition-all duration-300 top-3"
    :style="{
  ...
  >
    <div
      class="flex items-center justify-center w-full max-w-screen-xl gap-2 p-3 rounded-lg shadow-lg bg-background"
    >
